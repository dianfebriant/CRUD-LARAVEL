...
@section('title', 'FrontPage | Create')
@section('container')
                        ...
                        <form action="{{ route('frontpage.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('sub_title') is-invalid @enderror" name="sub_title"
                                    value="{{ old('sub_title') }}" placeholder="Masukkan Sub Judul">
                                <!-- error message untuk title -->
                                @error('sub_title')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('registration') is-invalid @enderror" name="registration"
                                    value="{{ old('registration') }}" placeholder="Masukkan Link Pendaftaran">
                                <!-- error message untuk title -->
                                @error('registration')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('video') is-invalid @enderror" name="video"
                                    value="{{ old('video') }}" placeholder="Masukkan Nama Kategori">
                                <!-- error message untuk title -->
                                @error('video')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('history') is-invalid @enderror" name="history" id="my-editor"
                                    rows="5"
                                    placeholder="Masukkan Deskripsi Post">{{ old('history') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('visi') is-invalid @enderror" name="visi" id="my-editor2"
                                    ...
                                    placeholder="Masukkan Deskripsi Post">{{ old('visi') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('misi') is-invalid @enderror" name="misi" id="my-editor3"
                                    ...
                                    placeholder="Masukkan Deskripsi Post">{{ old('misi') }}</textarea>
