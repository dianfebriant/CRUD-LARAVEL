    ...
    public function message()
    {
        switch (true) {
            ...
            case !$this->uppercasePasses
                && !$this->numericPasses
                && !$this->specialCharacterPasses:
                return ':attribute minimal harus 8 karakter dan mengandung minimal 1 karakter huruf besar, 1 angka, dan 1 karakter khusus.';

            default:
                return 'The :attribute minimal harus 8 karakter dan mengandung minimal 1 karakter khusus.';
        }
    }
}